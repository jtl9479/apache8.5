...
rem Scouter Agent 설정 (운영 서버에서 사용, 로컬 테스트시 주석처리)
rem set CATALINA_OPTS=-javaagent:C:\scouter\agent.java_6_7\scouter.agent.jar -Dscouter.config=C:\scouter\agent.java_6_7\conf\pda_in.conf -Dobj_name=PDA_IN
