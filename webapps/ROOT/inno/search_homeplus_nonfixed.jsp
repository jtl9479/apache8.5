...
System.out.println("====================================");
System.out.println("##search_shipment all parameter :" + qry_where);

try {
	conn = getMSSQLConnection();
	if(conn != null) {
		connection = true;
		System.out.println("INNO DB 연결 성공 HPLUS NONFIXED 성공");
	}
} catch (Exception e) {
	connection = false;
	System.out.println("INNO DB 연결 성공 HPLUS NONFIXED 실패");
